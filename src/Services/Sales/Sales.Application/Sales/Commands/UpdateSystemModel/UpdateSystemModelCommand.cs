...
{
    public  record UpdateSystemModelCommand(SystemModelDto SystemModel) : ICommand<UpdateSystemModelResult>;
    public record UpdateSystemModelResult(bool  IsSuccess);
    public class UpdateSystemModelValidator : AbstractValidator<UpdateSystemModelCommand>
    {
        public UpdateSystemModelValidator()
        {
